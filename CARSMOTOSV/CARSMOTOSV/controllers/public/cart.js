...
async function readDetail() {
    ...
    if (DATA.status) {
        ...
        DATA.dataset.forEach(row => {
            subtotal = row.precio_casco * row.cantidad_productos;
            total += subtotal;
            ...
            TABLE_BODY.innerHTML += `
                <tr>
                    ...
                    <td>
                        <button type="button" onclick="openUpdate(${row.id_detalle_pedidos}, ${row.cantidad_productos})" class="btn btn-info">
                            <i class="bi bi-plus-slash-minus"></i>
                        </button>
                        <button type="button" onclick="openDelete(${row.id_detalle_pedidos})" class="btn btn-danger">
